...
//	public static Task parseTask(final String untrust_name, final String untrust_encodedDate, final String untrust_encodedTime,final String untrust_category) {
        final String name;
        try {
...
//		try {
//			category = java.net.URLDecoder.decode(untrust_category, StandardCharsets.UTF_8.name());
//		}
//		catch (UnsupportedEncodingException ex) {
//			assert ("Impossible: missing utf8 charset encoding" == null);
//			throw new UnsupportedOperationException(ex.getMessage());
